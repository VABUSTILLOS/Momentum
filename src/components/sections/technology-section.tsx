...
export function TechnologySection() {
  ...
  const descriptionText = "Planea tu evento con la confianza de tenerlo todo resuelto. Momentum conecta experiencias, proveedores verificados y herramientas simples para que cada celebración tenga tu estilo, desde la primera cotización hasta el último baile."
            ...
            >
              ...
              >
                <h2 className="max-w-3xl font-medium leading-tight tracking-tight text-white md:text-5xl lg:text-7xl text-5xl">
                  {["Tu evento", "Tu estilo", "Tu momento."].map((word, index) => {
